 ...
 */
public class HttpClient4 implements ca.gc.nrc.iit.oauth.consumer.http.HttpClient {
    ...
    public HttpResponseMessage execute(HttpMessage request, Map<String, Object> parameters) 
    		throws IOException {
        ...
        for (Map.Entry<String, Object> p : parameters.entrySet()) {
            ...
            String value = OAuth.toString(p.getValue());
