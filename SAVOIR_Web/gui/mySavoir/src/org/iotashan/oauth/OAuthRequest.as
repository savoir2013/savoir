	...
	public class OAuthRequest
	{
		...
		*/
		public function buildRequest(signatureMethod:IOAuthSignatureMethod,resultType:String=RESULT_TYPE_URL_STRING,headerRealm:String=""):* {
			...
			//_requestParams["oauth_consumer_secret"] = _consumer.secret;
			...
			if (_token) {
				...
				if(_requestParams.hasOwnProperty("oauth_token_secret")){
					var checkDeleteSecret:Boolean = delete(_requestParams.oauth_token_secret);
				}
			}
			...
			switch (resultType) {
				...
				case RESULT_TYPE_HEADER:
					...
					var index:Number = data.lastIndexOf(",");
