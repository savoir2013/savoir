...
package savoirAutoComplete.components
{
 ...
 *
 */
public class ExpandingTextArea extends ScrollControlBase
...

{
     ...
     *  Constructor.
     */
    public function ExpandingTextArea()
    {
        super();
...
*/
                                                  ...
                                                  unscaledHeight:Number):void
    {
        ...
        textField.move(vm.left, vm.bottom);
...
*/
                                      ...
                                      dispatchValueCommitEvent:Boolean):void
    {
        ...
        if (changed2)
       	...
       	callLater(expandHeight);
    }


	private function expandHeight():void
	{
        ...
        this.height = _textHeight + this.measureText(_text).height;
	}
