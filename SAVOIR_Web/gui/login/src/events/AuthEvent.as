...
package events
{
	...
	public class AuthEvent extends Event
	{
		...
		public static const AUTH_REQUEST_TOKEN:String = "authReuqestToken";
		...
		public function AuthEvent(type:String, token:OAuthToken=null, bubbles:Boolean=false, cancelable:Boolean=false)
		{
