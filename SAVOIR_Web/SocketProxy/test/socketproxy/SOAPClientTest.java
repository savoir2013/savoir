...
public class SOAPClientTest extends TestCase
{
    ...
    /*
     * TestSOAPFromFileClient constructor
     ...
     */
    public SOAPClientTest (String url)
    {
        super(url);
    }
    ...
    public static void main(String[] args) throws Exception
    {
	    ...
	    System.err.println("SOAPAction is optional... \n\nSample call:");
            ...
            soapXML = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:user=\"http://userMgmt.savoir.iit.nrc.gc.ca/\"> <soapenv:Body> <user:getUsers/> </soapenv:Body> </soapenv:Envelope>";
        }
        
        CallService cs = new CallService();
        cs.callSOAP(serviceURL, soapXML);
    }
  ...
  public void testCallSOAP()
  {
     ...
     CallService cs = new CallService();
     assertEquals(expResult, cs.callSOAP(serviceURL, soapXML));
  }
}
