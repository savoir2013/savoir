 ...
 */
public class EKGTutorialBusInterfaceConsumerThread extends Thread implements MessageListener, ExceptionListener {
    ...
    private EKGTutorialService ekgService;

//    public static void main(String[] args) {
//        ArrayList<EKGTutorialBusInterfaceConsumerThread> threads = new ArrayList();
//        EKGTutorialBusInterfaceConsumerThread consumerTool = new EKGTutorialBusInterfaceConsumerThread();
...
//            consumerTool = new EKGTutorialBusInterfaceConsumerThread();
...
//
//        while (true) {
//            Iterator<EKGTutorialBusInterfaceConsumerThread> itr = threads.iterator();
//            int running = 0;
//            while (itr.hasNext()) {
//                EKGTutorialBusInterfaceConsumerThread thread = itr.next();
//                if (thread.isAlive()) {
//                    running++;
//                }
//            }
...
//        }
//    }
    public void initConsumer(String theUrl, String topic, EKGTutorialServiceAdapter serviceAdapter, EKGTutorialService service){
        url =  theUrl;
        subject = topic;
...
//                logger.info("Reading message: " + msg.getText());
                ...
                this.ekgService.processMessageFromBus(msgString);
            } else {
                if (verbose) {
