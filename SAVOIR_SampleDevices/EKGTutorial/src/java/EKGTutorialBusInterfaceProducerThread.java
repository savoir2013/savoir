 ...
 */
public class EKGTutorialBusInterfaceProducerThread extends Thread {
...
//        ArrayList<EKGTutorialBusInterfaceProducerThread> threads = new ArrayList();
//        EKGTutorialBusInterfaceProducerThread producerTool = new EKGTutorialBusInterfaceProducerThread();
...
//            producerTool = new EKGTutorialBusInterfaceProducerThread();
...
//
//        while (true) {
//            Iterator<EKGTutorialBusInterfaceProducerThread> itr = threads.iterator();
//            int running = 0;
//            while (itr.hasNext()) {
//                EKGTutorialBusInterfaceProducerThread thread = itr.next();
//                if (thread.isAlive()) {
//                    running++;
//                }
//            }
...
//            }
    ...
    protected void sendLoop(Session session, MessageProducer producer) throws Exception {
        ...
        while (!this.queue.isEmpty()) {
            ...
            TextMessage message = session.createTextMessage(this.queue.remove());
